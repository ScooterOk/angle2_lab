<template>
  <div id="app-team">    
    ...
    <!-- ============ TITLE =============== -->
    <ul class="about__title noselect" v-if="mobile">
      <li>
        <div class="left">            
          <h2>
            <span>A small</span>                
    ...
    <ul class="about__title noselect" v-else>
      <li>
        <div class="left">            
          <h2>
...
export default {
  ...
  watch : {
    ...
    mouseX: function(val){
      ...
      TweenMax.to(document.querySelectorAll('#app-team .about__title span'), 1, {x: function(i, el){
  ...
  transition : {
    ...
    leave : function(el, done){
      ...
      TweenMax.to('#app-team .back', 0.4, {scale: 0});
      ...
      .set(document.querySelectorAll('#app-team .wld span, .dda span'), {css : {'transition-duration' : '0.9s', 'letter-spacing': (app.$store.state.mobile == 'mobile' ? '10px' : '20px'), 'transition-timing-function' : 'cubic-bezier(0.505, 0.000, 0.735, 0.425)'}}, 'title+=0.4')
      .to(document.querySelectorAll('.dda span'), 0.4, {y : 0}, 'title+=1')
      .to(document.querySelectorAll('#app-team .wld span'), 0.4, {y : -13}, 'title+=1')        
