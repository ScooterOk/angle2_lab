<template>
  <div id="app-projects-sparky">
    ...
    <article class="case sparky">
      <section class="case__head">
        <div class="case__head_img-wrapper">
          <div
          ...
          >
            <img src="/img/projects/sparky/preview.jpg" alt="" />
          </div>
        </div>
        ...
        <div class="case__head_characteristic">
          <div class="output">
            ...
            <h5>
              <span>Interactive Promo Website</span>
            </h5>
          </div>
          <div class="creative">
            <h4>
          ...
          <div class="link">
            <div class="background">
              <a
                ...
                target="_blank"
                @mouseenter="hoverLinks"
                @mouseleave="hoverLinks"
              >
                <span>View site</span>
              </a>
            </div>
      ...
      <section class="quick-words leave">
        <div class="content startanim" data-type="quickWords">
          <div class="text">
            <h4>QUICK WORDS</h4>
            <p>
              Sparky is a USA based marketing agency. They are provide a fresh
              set of eyes for powerful brands looking to maximize moments,
              elevate experiences, and ignite innovation.<br />
              For this client we create Interactive promo-site which help to
              provide values of brand and services, declare yourself and be
              remembered. Also created the majority of visual solluetions all
              focused around the key brand message of fresh eyes for powerful
              brands.
            </p>
          </div>
        </div>
      ...
      <section class="home leave">
        <div class="content startanim imganim" data-type="home">
          <img src="/img/projects/sparky/home.jpg" alt="" />
        </div>
      </section>
      <section class="about leave">
        <div class="content startanim imganim" data-type="about">
          <img src="/img/projects/sparky/about.jpg" alt="" />
        </div>
      </section>
      <section class="services leave">
        <div class="content startanim imganim" data-type="services">
          <img src="/img/projects/sparky/services.jpg" alt="" />
        </div>
      </section>
      <section class="team leave">
        <div class="content startanim imganim" data-type="team">
          <img src="/img/projects/sparky/team.jpg" alt="" />
        </div>
      </section>
      <section class="mobile startanim leave" data-type="mobile">
        <div class="start">
          <div class="imganim">
            <img src="/img/projects/sparky/start-project.jpg" alt="" />
          </div>
        </div>
        <div class="intro-mobile">
          <div class="imganim">
            <img src="/img/projects/sparky/intro-mobile.jpg" alt="" />
          </div>
        </div>
        <div class="team-mobile">
          <div class="imganim">
            <img src="/img/projects/sparky/team-mobile.jpg" alt="" />
          </div>
        </div>
        <div class="error startanim" data-type="mobile2">
          <div class="imganim">
            <img src="/img/projects/sparky/404.jpg" alt="" />
          </div>
        </div>
      </section>
        ...
        <section class="next-project startanim" data-type="nextProject">
          ...
          <div class="next-project__img">
            <span
              ...
              data-startImage="/img/displacement/start.png"
            >
              <img src="/img/projects/cavio.jpg" alt="" />
            </span>
            <i></i>
          </div>
...
export default {
  mounted: function () {
    ...
    app.scrollbar = Scrollbar.init(document.querySelector(".case.sparky"), {
    ...
    app.$store.commit("set", {
      ...
      TweenMax.set(document.querySelectorAll("#app-projects-sparky .leave"), {
        opacity: 0,
      });
      ...
      var tl = new TimelineMax()
        ...
        .fromTo(
          ...
          },
          {
            ...
            ease: SlowMo.ease.config(0.2, 0.8, false),
            onComplete: function () {
              app.$router.push({ path: "/projects/cavio" });
            },
          }
        );
    },
...
#app-projects-sparky {
  ...
  .quick-words {
    padding-top: 70px;
    padding-bottom: calc(100px + (531px / 2));
    @media screen and (max-width: 1000px) {
      padding-bottom: calc(100px + (53.1vw / 2));
    }
    .content {
      margin: 0 auto;
      max-width: 1000px;
