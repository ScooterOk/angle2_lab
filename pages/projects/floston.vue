  ...
  <div id="app-projects-floston">
    ...
    <article class="case floston">
      <section class="case__head">
        ...
        >
          <img src="/img/projects/floston/preview.jpg" alt="" />
        </div>
      ...
      <div class="wrapper">
        <div class="contr">
          <div class="content-box1 startanim" data-type="management">
            <div class="bg-absolute">
              <img src="/img/projects/floston/bg1.png" alt />
            </div>
            <section class="section section--management">
              <div class="row">
                <p class="content__subtitle management__descr">
                  Simple and beautiful fleet management solution for small and
                  medium-sized businesses.
                </p>
                <div class="col img-wrapper">
                  <img src="/img/projects/floston/management.png" alt />
                </div>
              </div>
            </section>
              ...
              <div class="row">
                <div class="content__block content__block--right">
                  ...
                  <p class="content__subtitle">
                    System helps to receive the answers:
                  </p>
            ...
            <section
              class="section section--eval startanim"
              data-type="evaluation"
            >
              <div class="row">
                <div class="content__block">
                  <h3 class="content__title">
                    <span class="content__title-numb">2</span>Evaluation report
                    findings
                  </h3>
                  <p class="content__subtitle">
                    After we audited the existing system, we focused on the
                    following problems:
                  </p>
                  <div class="content__descr">
                    <ul class="content__list">
                      ...
                      <li>
                        It's not clear for users how can they do their work in
                        the system
                      </li>
                      <li>
            ...
            <section class="section startanim" data-type="solutions">
              <div class="row">
                <div class="content__block content__block--right">
                  ...
                  <p class="content__subtitle">
                    And we provided following solutions:
                  </p>
                  <div class="content__descr">
                    <ul class="content__list">
                      <li>
                        Separate all users into three roles and wrote scenarios
                        and procedures for each of role
                      </li>
        ...
        <div class="content-box2 startanim" data-type="roles">
          <div class="contr">
            <div class="bg-absolute">
              <img src="/img/projects/floston/roles.svg" alt />
            </div>
            <section class="section">
              <div class="content__block">
                ...
                <p class="content__subtitle">
                  We built a dedicated area for each role
                </p>
              </div>
          ...
          <section class="section">
            ...
            <div class="contr contr--wireframes">
              <div class="pic-contain-width img-wrapper">
                <img src="/img/projects/floston/wireframes.png" alt />
              </div>
            </div>
          </section>
        </article>
        <div class="content-box3">
            ...
            <section class="section startanim" data-type="userInterface">
              <div class="contr">
                <div class="row justify-content-center">
                  <div class="content__block">
                    <h3 class="content__title content-article__title">
                      <span class="content__title-numb">6</span>User Interface
                      Design
                    </h3>
                  </div>
                </div>
                <div class="pic-full-width img-wrapper">
                  <img src="/img/projects/floston/interface-design1.png" alt />
                </div>
              </div>
            </section>
          </article>
          <section class="section section--alerts startanim" data-type="alert">
            <div class="contr">
              ...
              <div class="pic-full-width img-wrapper">
                <img src="/img/projects/floston/interface-design2.png" alt />
              </div>
            </div>
          </section>
          <article class="content-article">
                ...
                <div class="row">
                  <div class="car__block">
                    <figure class="car__figure">
                      <img src="/img/projects/floston/car-blue.svg" alt />
                      <figcaption class="car__figcaption">active</figcaption>
                    </figure>
                  </div>
                  <div class="car__block">
                    <figure class="car__figure">
                      <img src="/img/projects/floston/car-yellow.svg" alt />
                      <figcaption class="car__figcaption">free</figcaption>
                    </figure>
                  </div>
                  <div class="car__block">
                    <figure class="car__figure">
                      <img src="/img/projects/floston/car-red.svg" alt />
                      <figcaption class="car__figcaption">
                        critical problem
                      </figcaption>
                    </figure>
                  </div>
                  <div class="car__block">
                    <figure class="car__figure">
                      <img src="/img/projects/floston/car-grey.svg" alt />
            ...
            <div class="contr">
              <div class="pic-full-width">
                <div class="img-wrapper">
                  <img src="/img/projects/floston/interface-design3.png" alt />
                </div>
              </div>
            </div>
          </article>
          <article class="content-article contacts">
            <section class="section startanim" data-type="contacts">
              <div class="contr contr--no-pading">
                <div class="pic-full-width">
                  <div class="img-wrapper">
                    <img src="/img/projects/floston/contacts.png" alt />
                  </div>
                </div>
              </div>
            </section>
          ...
          <section class="next-project startanim" data-type="nextProject">
            ...
            <div class="next-project__img">
              <span
                ...
                data-startImage="/img/displacement/start.png"
              >
                <img src="/img/projects/sparky.jpg" alt="" />
              </span>
              <i></i>
            </div>
...
export default {
  mounted: function () {
    ...
    app.$store.commit("set", {
      ...
      TweenMax.set(
        document.querySelectorAll(".wrapper > *:not(.next-project-wrapper)"),
        { opacity: 0 }
      );
      TweenMax.set(
...
#app-projects-floston {
  ...
  [data-type="alert"] .interception {
    background-image: url("/img/projects/floston/interface-design2.png");
    background-repeat: no-repeat;
    background-size: cover;
    background-color: transparent;
  }
  [data-type="screenshots"] .interception {
    background-image: url("/img/projects/floston/interface-design3.png");
    background-repeat: no-repeat;
    background-size: cover;
    background-color: transparent;
  }
  ...
  [data-type="contacts"] .interception {
    background-image: url("/img/projects/floston/contacts.png");
    background-repeat: no-repeat;
    background-size: cover;
    background-color: transparent;
