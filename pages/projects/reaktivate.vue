  ...
  <div id="app-projects-reactivate" :class="mobile ? 'mobile' : ''">
    ...
    <article class="case reactivate">
      <section class="case__head">
        ...
        >
          <img src="/img/projects/reactivate/preview.jpg" alt="" />
        </div>
      ...
      <div class="reactivate__body">
          ...
          <div class="contr">
            ...
            <div class="descr">
              <div class="descr__block">
                ...
                <p class="descr__text">
                  Promotional website for agency that develops the Mobile Apps.
                  The project has a simple idea, it is to show the unity of
                  style only when interacting. Also, this unusual interaction
                  helps to better involve and immerse in the agency's cases.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="section-with-bg startanim" data-type="preview">
          <div class="bg-absolute">
            <img src="/img/projects/reactivate/bg.jpg" alt="" />
          </div>
          <div class="contr">
            <div class="img-wrapper">
              <i class="interception"></i>
              <img src="/img/projects/pulser.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <ul class="slides startanim" data-type="slides">
          <li>
            <div class="interception"></div>
            <img src="/img/projects/carousel/slide3.jpg" alt="" />
          </li>
          <li>
            <div class="interception"></div>
            <img src="/img/projects/carousel/slide1.jpg" alt="" />
          </li>
          <li>
            <div class="interception"></div>
            <img src="/img/projects/carousel/slide2.jpg" alt="" />
          </li>
        </ul>
        ...
        <div class="section-about startanim" data-type="about">
          ...
          <div class="contr">
            <div class="img-wrapper">
              <i class="interception"></i>
              <img src="/img/projects/pulser-about.jpg" alt="" />
            </div>
          </div>
        </div>
            ...
            <div class="mobile-section__circle">
              ...
              <div class="samples">
                <div class="samples__left">
                  <div class="interception"></div>
                  <img src="/img/projects/mobile-samples.png" alt="" />
                </div>
                <div class="samples__right">
                  <div class="interception"></div>
                  <img src="/img/projects/mobile-stat.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="next-project startanim" data-type="nextProject">
          ...
          <div class="next-project__img">
            <span
              ...
              data-startImage="/img/displacement/start.png"
            >
              <img src="/img/projects/reactivate/next-project.jpg" alt="" />
            </span>
            <i></i>
          </div>
